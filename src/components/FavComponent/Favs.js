...
import { H1, Tooltip, NonIdealState, Classes, Overlay, Button, Intent, Code } from "@blueprintjs/core";
...
class Favs extends Component {
  ...
  openOverLay = () => {
    return <Overlay onClose={this.handleClose} className="center" {...this.state}>
      <div className={this.classes} style={{ width: "380px" }}>
        ...
        <div className={Classes.DIALOG_FOOTER_ACTIONS} style={{ marginTop: "30px" }}>
          <Button intent={Intent.DANGER} onClick={this.handleClose} style={{ marginRight: "10px" }}>
            Close
                    </Button>
