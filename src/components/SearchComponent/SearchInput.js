...
export default class SearchInput extends Component {
    ...
    render() {
        return <div className="bp3-input-group bp3-large" style={searchStyle}>
                ...
                <Link className="bp3-button bp3-minimal bp3-intent-primary bp3-icon-arrow-right" to={'/tags/' + (this.state.value.toString()===''?'landscape':this.state.value.toString())}></Link>
